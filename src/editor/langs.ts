...
const HCL_KEYWORDS = new Set([
  "resource", "variable", "module", "data", "output", "provider", "locals",
  "terraform", "backend", "provisioner", "connection", "dynamic", "for_each",
  "count", "depends_on", "lifecycle", "true", "false", "null", "for", "in",
  "if", "else", "endif", "endfor",
]);
