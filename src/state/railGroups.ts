...
export type RailGroup = "project" | "ssh" | "plugins" | "apis" | "command";

export const RAIL_GROUP_ORDER: readonly RailGroup[] = ["project", "ssh", "plugins", "apis", "command"];
