...
export const PERSISTED_WINDOW_ROLES = new Set<WindowRole>(["term", "files", "git", "search", "bruno", "ssh-config", "named", "agent"]);

const CORE_SESSION_KINDS = new Set<string>(["project", "command", "ssh", "bruno"]);
